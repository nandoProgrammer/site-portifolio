    ...
    <Footer background={circlesLeft}>
      <Wrapper direction={"row"} justify={"space-between"}>
        <div>
          ...
          <Paragraph>
            Eu adoraria ouvir sobre seu projeto e como posso ajudar.
          </Paragraph>
        </div>
        <div>
          <Nav>
            <ul>
              <li
                onClick={() =>
                  redirectTo(
                    "https://www.linkedin.com/in/fernando-pereira-costa"
                  )
                }
              >
              ...
              <li
                onClick={() => redirectTo("https://github.com/nandoProgrammer")}
              >
      ...
      <Wrapper direction={"row"} justify={"center"} alignItems={"center"}>
